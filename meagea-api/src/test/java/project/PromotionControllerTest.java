...
public class PromotionControllerTest {
    ...
    @Test
    public void 입양_홍보글_생성() throws ExecutionException, InterruptedException {
        MultiValueMap<String, Object> map = new LinkedMultiValueMap<>();
        map.add("title", "제목");
        map.add("animalNo", 2151);
        ...
        PromotionDetailDto detailDto = (PromotionDetailDto) responseEntity.getBody();
